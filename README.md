...
:-------------------------:|:-------------------------:|:-------------------------:
400x400 pixel              |![](readme_images/input_400.png){width=600px} |  ![](readme_images/output_400.png){width=600px}
300x300 pixel              |![](readme_images/input_300.png){width=600px} |  ![](readme_images/output_300.png){width=600px}
200x200 pixel              |![](readme_images/input_200.png){width=600px} |  ![](readme_images/output_200.png){width=600px}
150x150 pixel              |![](readme_images/input_150.png){width=600px} |  ![](readme_images/output_150.png){width=600px}
100x100 pixel              |![](readme_images/input_100.png){width=600px} |  ![](readme_images/output_100.png){width=600px}
...
Generated  |  Original        
:-------------------------:|:-------------------------:
![](readme_images/output_400.png){width=600px} | ![](readme_images/original.png){width=600px}
